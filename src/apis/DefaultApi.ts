...
export class DefaultApi extends runtime.BaseAPI {
     ...
     */
    async getDeskReportsRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<DeskReportsResponse>> {
        const queryParameters: any = {};
     ...
     * The Desk (WINAD-10311 / D-14) — live reports of the current user\'s account only, newest activity first (GREATEST(published_at, current version\'s created_at once past v1) DESC). Drafts, building and hidden reports are never listed. 
     */
    async getDeskReports(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DeskReportsResponse> {
        const response = await this.getDeskReportsRaw(initOverrides);
        return await response.value();
    }
