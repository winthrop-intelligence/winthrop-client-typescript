...
import {
    ...
    GamePostGapCountCollectionFromJSON,
    GamePostGapCountCollectionToJSON,
...
export interface DefaultApiGetGamePostSearchGapCountsRequest {
...
export class DefaultApi extends runtime.BaseAPI {
    ...
    async createScheduleIntentRaw(requestParameters: DefaultApiCreateScheduleIntentOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScheduleIntentDetail>> {
        ...
        if (requestParameters['skipGamePostSync'] != null) {
            queryParameters['skip_game_post_sync'] = requestParameters['skipGamePostSync'];
        }
     ...
     */
    async getGamePostSearchGapCountsRaw(requestParameters: DefaultApiGetGamePostSearchGapCountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GamePostGapCountCollection>> {
        if (requestParameters['windows'] == null) {
            throw new runtime.RequiredError(
                'windows',
                'Required parameter "windows" was null or undefined when calling getGamePostSearchGapCounts().'
            );
        }
        ...
        if (requestParameters['windows'] != null) {
            queryParameters['windows'] = requestParameters['windows'];
        }
        ...
        let urlPath = `/api/v1/game_post_searches/gap_counts`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => GamePostGapCountCollectionFromJSON(jsonValue));
    }

    /**
     * Counts-only companion to the game post search for the sidebar schedule-gaps module (WINAD-9904). Accepts the same q filters as the search plus 1-10 date windows, and returns the number of active feed posts overlapping each window — each count equals what applying that window as a date filter to the search would return.
     */
    async getGamePostSearchGapCounts(requestParameters: DefaultApiGetGamePostSearchGapCountsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GamePostGapCountCollection> {
        const response = await this.getGamePostSearchGapCountsRaw(requestParameters, initOverrides);
        return await response.value();
    }
