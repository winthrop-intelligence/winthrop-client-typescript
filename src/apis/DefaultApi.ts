...
import {
    ...
    CreateGamePostRequestFromJSON,
    CreateGamePostRequestToJSON,
    ...
    EadaFinancialSearchResponseFromJSON,
    EadaFinancialSearchResponseToJSON,
    EadaMetricCatalogResponseFromJSON,
    EadaMetricCatalogResponseToJSON,
    ...
    FiltersFromJSON,
    FiltersToJSON,
    FinancialComparisonResponseFromJSON,
    FinancialComparisonResponseToJSON,
    FinancialSearchResultCollectionFromJSON,
    FinancialSearchResultCollectionToJSON,
    FinancialSelectionFromJSON,
    FinancialSelectionToJSON,
    FoiaLabelFromJSON,
    FoiaLabelToJSON,
    ...
    SchoolEadaFinancialsFromJSON,
    SchoolEadaFinancialsToJSON,
...
export interface DefaultApiCreateGamePostOperationRequest {
    createGamePostRequest: CreateGamePostRequest;
}
...
export interface DefaultApiGetEadaFinancialSearchesRequest {
    year: number;
    page?: number;
    perPage?: number;
    q?: object;
    grain?: GetEadaFinancialSearchesGrainEnum;
    sportCode?: string;
    family?: string;
    gender?: string;
    metric?: string;
...
export interface DefaultApiGetEadaMetricsRequest {
    page?: number;
    perPage?: number;
    reportType?: GetEadaMetricsReportTypeEnum;
    canonicalOnly?: boolean;
    comparabilityState?: GetEadaMetricsComparabilityStateEnum;
    search?: string;
}
...
export interface DefaultApiGetFinancialComparisonsRequest {
    schoolIds: Array<number>;
    source?: GetFinancialComparisonsSourceEnum;
    grain?: GetFinancialComparisonsGrainEnum;
    sportName?: string;
    year?: number;
    metric?: string;
}
...
export interface DefaultApiGetSchoolEadaFinancialsRequest {
    schoolId: number;
    year: number;
    grain?: GetSchoolEadaFinancialsGrainEnum;
    sportCode?: string;
    family?: string;
    gender?: string;
    metric?: string;
...
export interface DefaultApiGetSchoolFinancialSelectionRequest {
    schoolId: number;
    source?: GetSchoolFinancialSelectionSourceEnum;
    grain?: GetSchoolFinancialSelectionGrainEnum;
    sportName?: string;
    year?: number;
    metric?: string;
}
...
export interface DefaultApiUpdateCompensationRequest {
    compensationId: number;
    compensation: Omit<Compensation, 'coach_id'|'year'|'school_id'>;
}
...
export class DefaultApi extends runtime.BaseAPI {
     ...
     */
    async createGamePostRaw(requestParameters: DefaultApiCreateGamePostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GamePost>> {
        if (requestParameters['createGamePostRequest'] == null) {
            throw new runtime.RequiredError(
                'createGamePostRequest',
                'Required parameter "createGamePostRequest" was null or undefined when calling createGamePost().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: CreateGamePostRequestToJSON(requestParameters['createGamePostRequest']),
        }, initOverrides);
     ...
     * Create a game post. It lands on the school named by `school_id`, and on the current user\'s own school when that is omitted.  WINAD-10272: a school-unscoped grant (scheduling staff loading an emailed schedule, or a super admin) may name any school; a school-scoped user naming a school other than their own is refused with 403, and an unknown id is 404.
     */
    async createGamePost(requestParameters: DefaultApiCreateGamePostOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GamePost> {
     ...
     */
    async getEadaFinancialSearchesRaw(requestParameters: DefaultApiGetEadaFinancialSearchesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EadaFinancialSearchResponse>> {
        if (requestParameters['year'] == null) {
            throw new runtime.RequiredError(
                'year',
                'Required parameter "year" was null or undefined when calling getEadaFinancialSearches().'
            );
        }
        ...
        if (requestParameters['grain'] != null) {
            queryParameters['grain'] = requestParameters['grain'];
        }

        if (requestParameters['sportCode'] != null) {
            queryParameters['sport_code'] = requestParameters['sportCode'];
        }
        ...
        let urlPath = `/api/v1/eada_financial_searches`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EadaFinancialSearchResponseFromJSON(jsonValue));
    }

    /**
     * WINAD-10370 — paginated cross-school EADA cohort search for one exact reporting year and grain (institution or sport). Scoped to schools the viewer holds see_eada_financials on, including private schools with an EADA-only grant.
     */
    async getEadaFinancialSearches(requestParameters: DefaultApiGetEadaFinancialSearchesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EadaFinancialSearchResponse> {
        const response = await this.getEadaFinancialSearchesRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getEadaMetricsRaw(requestParameters: DefaultApiGetEadaMetricsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<EadaMetricCatalogResponse>> {
        const queryParameters: any = {};
        ...
        if (requestParameters['canonicalOnly'] != null) {
            queryParameters['canonical_only'] = requestParameters['canonicalOnly'];
        }

        if (requestParameters['comparabilityState'] != null) {
            queryParameters['comparability_state'] = requestParameters['comparabilityState'];
        }
        ...
        let urlPath = `/api/v1/eada_metrics`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => EadaMetricCatalogResponseFromJSON(jsonValue));
    }

    /**
     * WINAD-10370 — serves the WINAD-10371 metric/source-field catalog so API consumers can retrieve field definitions (label, description, unit, grain, comparability metadata) without hardcoding them. Reference data; returns the full filtered set (no see_eada_financials gate).
     */
    async getEadaMetrics(requestParameters: DefaultApiGetEadaMetricsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<EadaMetricCatalogResponse> {
        const response = await this.getEadaMetricsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getFinancialComparisonsRaw(requestParameters: DefaultApiGetFinancialComparisonsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FinancialComparisonResponse>> {
        if (requestParameters['schoolIds'] == null) {
            throw new runtime.RequiredError(
                'schoolIds',
                'Required parameter "schoolIds" was null or undefined when calling getFinancialComparisons().'
            );
        }
        ...
        if (requestParameters['schoolIds'] != null) {
            queryParameters['school_ids'] = requestParameters['schoolIds']!.join(runtime.COLLECTION_FORMATS["csv"]);
        }
        ...
        let urlPath = `/api/v1/financial_comparisons`;
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => FinancialComparisonResponseFromJSON(jsonValue));
    }

    /**
     * WINAD-10369 — cohort-level source-aware financial comparison (e.g. one conference plus a couple of out-of-conference peers). Runs Financials::SourceSelection independently per school (never merges line items across schools\' reports) and, when metric is given, adds Financials::Comparison\'s mixed-source ranking on top — a catalog-approved (comparability_state mergeable) canonical metric gets one blended ranking across sources; every other metric gets per-source rankings only, kept visibly separate. A school id the viewer holds neither see_financials nor see_eada_financials on for is silently dropped from the cohort rather than 403ing the whole request.
     */
    async getFinancialComparisons(requestParameters: DefaultApiGetFinancialComparisonsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FinancialComparisonResponse> {
        const response = await this.getFinancialComparisonsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getSchoolEadaFinancialsRaw(requestParameters: DefaultApiGetSchoolEadaFinancialsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SchoolEadaFinancials>> {
        if (requestParameters['schoolId'] == null) {
            throw new runtime.RequiredError(
                'schoolId',
                'Required parameter "schoolId" was null or undefined when calling getSchoolEadaFinancials().'
            );
        }
        ...
        if (requestParameters['year'] == null) {
            throw new runtime.RequiredError(
                'year',
                'Required parameter "year" was null or undefined when calling getSchoolEadaFinancials().'
            );
        }
        ...
        let urlPath = `/api/v1/schools/{schoolId}/eada_financials`;
        urlPath = urlPath.replace(`{${"schoolId"}}`, encodeURIComponent(String(requestParameters['schoolId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => SchoolEadaFinancialsFromJSON(jsonValue));
    }

    /**
     * WINAD-10370 — normalized EADA institution and sport financials for a school at an exact reporting year. Never substitutes a different year when the requested one is missing — institution.found/sports.found are explicit instead. Requires the see_eada_financials capability (exposed via GET /users/me as can_see_eada_financials).
     */
    async getSchoolEadaFinancials(requestParameters: DefaultApiGetSchoolEadaFinancialsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SchoolEadaFinancials> {
        const response = await this.getSchoolEadaFinancialsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async getSchoolFinancialSelectionRaw(requestParameters: DefaultApiGetSchoolFinancialSelectionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<FinancialSelection>> {
        if (requestParameters['schoolId'] == null) {
            throw new runtime.RequiredError(
                'schoolId',
                'Required parameter "schoolId" was null or undefined when calling getSchoolFinancialSelection().'
            );
        }
        ...
        let urlPath = `/api/v1/schools/{schoolId}/financial_selection`;
        urlPath = urlPath.replace(`{${"schoolId"}}`, encodeURIComponent(String(requestParameters['schoolId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => FinancialSelectionFromJSON(jsonValue));
    }

    /**
     * WINAD-10369 — one school\'s source-aware financial selection (eada | ncaa_frs | best_available | both) at institution or sport grain, layered on WINAD-10370\'s EADA API and the existing NCAA/FRS CashflowSum/Cashflow data via Financials::SourceSelection. best_available never 403s for a partial grant — it silently narrows to whichever source(s) the viewer can see for this school; requesting a single source (eada or ncaa_frs) the viewer cannot see for this school is a 403.
     */
    async getSchoolFinancialSelection(requestParameters: DefaultApiGetSchoolFinancialSelectionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<FinancialSelection> {
        const response = await this.getSchoolFinancialSelectionRaw(requestParameters, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const GetEadaFinancialSearchesGrainEnum = {
    Institution: 'institution',
    Sport: 'sport'
} as const;
export type GetEadaFinancialSearchesGrainEnum = typeof GetEadaFinancialSearchesGrainEnum[keyof typeof GetEadaFinancialSearchesGrainEnum];
/**
 * @export
 */
export const GetEadaMetricsReportTypeEnum = {
    Institution: 'institution',
    Sport: 'sport'
} as const;
export type GetEadaMetricsReportTypeEnum = typeof GetEadaMetricsReportTypeEnum[keyof typeof GetEadaMetricsReportTypeEnum];
/**
 * @export
 */
export const GetEadaMetricsComparabilityStateEnum = {
    Mergeable: 'mergeable',
    ComparisonOnly: 'comparison_only',
    NotComparable: 'not_comparable',
    SourceOnly: 'source_only'
} as const;
export type GetEadaMetricsComparabilityStateEnum = typeof GetEadaMetricsComparabilityStateEnum[keyof typeof GetEadaMetricsComparabilityStateEnum];
/**
 * @export
 */
 ...
 * @export
 */
export const GetFinancialComparisonsSourceEnum = {
    Eada: 'eada',
    NcaaFrs: 'ncaa_frs',
    BestAvailable: 'best_available',
    Both: 'both'
} as const;
export type GetFinancialComparisonsSourceEnum = typeof GetFinancialComparisonsSourceEnum[keyof typeof GetFinancialComparisonsSourceEnum];
/**
 * @export
 */
export const GetFinancialComparisonsGrainEnum = {
    Institution: 'institution',
    Sport: 'sport'
} as const;
export type GetFinancialComparisonsGrainEnum = typeof GetFinancialComparisonsGrainEnum[keyof typeof GetFinancialComparisonsGrainEnum];
/**
 * @export
 */
 ...
 * @export
 */
export const GetSchoolEadaFinancialsGrainEnum = {
    Institution: 'institution',
    Sport: 'sport'
} as const;
export type GetSchoolEadaFinancialsGrainEnum = typeof GetSchoolEadaFinancialsGrainEnum[keyof typeof GetSchoolEadaFinancialsGrainEnum];
/**
 * @export
 */
export const GetSchoolFinancialSelectionSourceEnum = {
    Eada: 'eada',
    NcaaFrs: 'ncaa_frs',
    BestAvailable: 'best_available',
    Both: 'both'
} as const;
export type GetSchoolFinancialSelectionSourceEnum = typeof GetSchoolFinancialSelectionSourceEnum[keyof typeof GetSchoolFinancialSelectionSourceEnum];
/**
 * @export
 */
export const GetSchoolFinancialSelectionGrainEnum = {
    Institution: 'institution',
    Sport: 'sport'
} as const;
export type GetSchoolFinancialSelectionGrainEnum = typeof GetSchoolFinancialSelectionGrainEnum[keyof typeof GetSchoolFinancialSelectionGrainEnum];
/**
 * @export
 */
