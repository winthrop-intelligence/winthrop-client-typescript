...
import {
    ...
    RawContractPreviewUrl200ResponseFromJSON,
    RawContractPreviewUrl200ResponseToJSON,
...
export interface DefaultApiRawContractPreviewUrlRequest {
    rawContractId: number;
}
...
export class DefaultApi extends runtime.BaseAPI {
     ...
     */
    async rawContractPreviewUrlRaw(requestParameters: DefaultApiRawContractPreviewUrlRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RawContractPreviewUrl200Response>> {
        if (requestParameters['rawContractId'] == null) {
            throw new runtime.RequiredError(
                'rawContractId',
                'Required parameter "rawContractId" was null or undefined when calling rawContractPreviewUrl().'
            );
        }
        ...
        let urlPath = `/api/v1/raw_contracts/{raw_contractId}/preview_url`;
        urlPath = urlPath.replace(`{${"raw_contractId"}}`, encodeURIComponent(String(requestParameters['rawContractId'])));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => RawContractPreviewUrl200ResponseFromJSON(jsonValue));
    }

    /**
     * Return the short-lived presigned storage URL for the raw contract PDF as JSON, for viewers that range-load the file directly from object storage.
     */
    async rawContractPreviewUrl(requestParameters: DefaultApiRawContractPreviewUrlRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RawContractPreviewUrl200Response> {
        const response = await this.rawContractPreviewUrlRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     */
    async viewRawContractFileRaw(requestParameters: DefaultApiViewRawContractFileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        if (requestParameters['rawContractId'] == null) {
            throw new runtime.RequiredError(
                'rawContractId',
     ...
     * Redirect to a short-lived presigned storage URL for the raw contract PDF (no watermark), so the client can range-load it directly from object storage. Clients that only need the URL itself should call preview_url instead of following this redirect.
     */
    async viewRawContractFile(requestParameters: DefaultApiViewRawContractFileRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.viewRawContractFileRaw(requestParameters, initOverrides);
    }
