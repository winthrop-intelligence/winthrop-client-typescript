...
import type { NewerSeasonContext } from './NewerSeasonContext';
import {
    NewerSeasonContextFromJSON,
    NewerSeasonContextFromJSONTyped,
    NewerSeasonContextToJSON,
    NewerSeasonContextToJSONTyped,
} from './NewerSeasonContext';
...
export function AdministratorFromJSONTyped(json: any, ignoreDiscriminator: boolean): Administrator {
    ...
    return {
        ...
        'newerSeason': json['newer_season'] == null ? undefined : NewerSeasonContextFromJSON(json['newer_season']),
...
export function AdministratorToJSONTyped(value?: Administrator | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'year': value['year'],
        'newer_season': NewerSeasonContextToJSON(value['newerSeason']),
