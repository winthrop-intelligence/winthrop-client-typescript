...
export interface User {
    ...
    /**
     * Whether the user can access the normalized EADA institution/sport financials API (WINAD-10370). A class-level check; per-school visibility (e.g. division-scoped subscriptions, private-school access) is still enforced per-request.
     * @type {boolean}
     * @memberof User
     */
    ...
    /**
     * Whether The Desk exists for this user (WINAD-10415 / D-29): super admin, or an
     * active non-viewer user with at least one LIVE report that reaches them — published
     * to their account and, when restricted, naming them as a recipient. One flag
     * gates the whole feature — nav entry, /desk/* routes, gallery, reader, downloads,
     * archive and every ask affordance. Computed per request, so a publish or a hide
     * shows on the next fetch.
     * 
     * @type {boolean}
     * @memberof User
     */
     ...
     * @memberof User
     */
    schedulingPhoneDefault?: string | null;
    /**
...
export function UserFromJSONTyped(json: any, ignoreDiscriminator: boolean): User {
    ...
    return {
        ...
        'canShowDesk': json['can_show_desk'] == null ? undefined : json['can_show_desk'],
        ...
        'schedulingPhoneDefault': json['scheduling_phone_default'] == null ? undefined : json['scheduling_phone_default'],
...
export function UserToJSONTyped(value?: User | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'can_show_desk': value['canShowDesk'],
        ...
        'scheduling_phone_default': value['schedulingPhoneDefault'],
