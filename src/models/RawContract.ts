...
export interface RawContract {
    ...
    /**
     * Current Mistral OCR text. Null for legacy rows that have not been OCR'd by Mistral (see `gs_text`).
     * @type {string}
     * @memberof RawContract
     */
    text?: string | null;
    /**
     * Legacy Ghostscript OCR text. Historical only; `text` holds the current Mistral OCR and takes precedence over this field. Null for rows created after the Mistral migration.
     * @type {string}
     * @memberof RawContract
     */
    gsText?: string | null;
...
export function RawContractFromJSONTyped(json: any, ignoreDiscriminator: boolean): RawContract {
    ...
    return {
        ...
        'gsText': json['gs_text'] == null ? undefined : json['gs_text'],
