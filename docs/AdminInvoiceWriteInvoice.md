...
`notes` | string
`reminders` | boolean
`billingAddressesAttributes` | [Array&lt;AdminInvoiceWriteInvoiceBillingAddressesAttributesInner&gt;](AdminInvoiceWriteInvoiceBillingAddressesAttributesInner.md)
...
const example = {
  ...
  "notes": null,
  "reminders": null,
  "billingAddressesAttributes": null,
