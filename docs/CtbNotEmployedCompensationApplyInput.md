...
```typescript
import type { CtbNotEmployedCompensationApplyInput } from '@winthrop-intelligence/winthrop-client-typescript'
...
} satisfies CtbNotEmployedCompensationApplyInput
...
const exampleParsed = JSON.parse(exampleJSON) as CtbNotEmployedCompensationApplyInput
