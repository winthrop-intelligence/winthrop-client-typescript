...
Administrator search result. Compensation fields are only included when the user has administrator_compensation permission. In /administrator_searches responses, contract fields are only included when the user can view the related contract or raw contract.
