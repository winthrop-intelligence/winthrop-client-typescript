...
```typescript
import type { CtbThirdPartyContractorCompensationApplyInput } from '@winthrop-intelligence/winthrop-client-typescript'
...
} satisfies CtbThirdPartyContractorCompensationApplyInput
...
const exampleParsed = JSON.parse(exampleJSON) as CtbThirdPartyContractorCompensationApplyInput
