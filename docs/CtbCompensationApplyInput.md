...
```typescript
import type { CtbCompensationApplyInput } from '@winthrop-intelligence/winthrop-client-typescript'
...
} satisfies CtbCompensationApplyInput
...
const exampleParsed = JSON.parse(exampleJSON) as CtbCompensationApplyInput
