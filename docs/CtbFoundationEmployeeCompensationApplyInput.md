...
```typescript
import type { CtbFoundationEmployeeCompensationApplyInput } from '@winthrop-intelligence/winthrop-client-typescript'
...
} satisfies CtbFoundationEmployeeCompensationApplyInput
...
const exampleParsed = JSON.parse(exampleJSON) as CtbFoundationEmployeeCompensationApplyInput
