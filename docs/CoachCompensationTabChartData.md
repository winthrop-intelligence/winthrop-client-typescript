...
```typescript
import type { CoachCompensationTabChartData } from '@winthrop-intelligence/winthrop-client-typescript'
...
} satisfies CoachCompensationTabChartData
...
const exampleParsed = JSON.parse(exampleJSON) as CoachCompensationTabChartData
