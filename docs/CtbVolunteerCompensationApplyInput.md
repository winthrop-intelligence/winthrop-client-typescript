...
```typescript
import type { CtbVolunteerCompensationApplyInput } from '@winthrop-intelligence/winthrop-client-typescript'
...
} satisfies CtbVolunteerCompensationApplyInput
...
const exampleParsed = JSON.parse(exampleJSON) as CtbVolunteerCompensationApplyInput
