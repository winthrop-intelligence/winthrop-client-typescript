...
> ScheduleGridAvailableSchools getScheduleGridAvailableSchools(sportName, targetDate, windowDays, includeNoConflict, matchTournaments, dealTypes, qualityTier, rankingTier, torvikRankingTier, maxDistanceMiles, userSchoolId, excludeSchoolIds)
