...
export const server1 = new ServerConfiguration<{  }>("http://api-gateway.default.svc.cluster.local", {  })
export const server2 = new ServerConfiguration<{  }>("https://api.demo.winad-hq.com", {  })
export const server3 = new ServerConfiguration<{  }>("https://api.winad-hq.com", {  })
